...
const Footer = () => {
  return (
    <div className="w-11/12 mx-auto my-3  shadow-md hover:shadow-sm transition-shadow mb-5">
      <footer className="bg-muted p-10 rounded-2xl">
        <div className="flex flex-col sm:flex-wrap sm:flex-row sm:justify-between gap-10 text-center sm:text-left">
          {/* Logo */}
          ...
          <nav className="flex-1">
            ...
            <div className="flex flex-col gap-2 text-left items-start sm:items-start">
