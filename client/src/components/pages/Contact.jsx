  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <section className="text-center mb-16">
        <h1 className="text-4xl font-bold mb-4">Contact AthleticHub</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">support@athletichub.com</p>
                <p className="text-gray-600">partners@athletichub.com</p>
              </div>
            </div>
